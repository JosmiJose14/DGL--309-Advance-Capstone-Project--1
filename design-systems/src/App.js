      ...
      <div
        ...
        <ul>
          <li>
            ...
            <button style={{cursor: 'pointer', color: '#ECD1A0', backgroundColor: 'black', width: 200, fontWeight: '900' }} onClick={() => setMenuItem(1)}>Typography & Color</button>
          </li>
          <li>
            {/* <a href="">Navigations</a> */}
            <button style={{cursor: 'pointer', color: '#ECD1A0', backgroundColor: 'black', fontWeight: '900' }} onClick={() => setMenuItem(0)}>Navigations</button>
          </li>
          <li>
            {/* <a href="javascript:void(0)" onClick={setMenuItem(2)}>Forms</a> */}
            <button style={{cursor: 'pointer', color: '#ECD1A0', backgroundColor: 'black', fontWeight: '900' }} onClick={() => setMenuItem(2)}>Forms</button>
          </li>
          <li>
            {/* <a href="">Lists</a> */}
          ...
          <li>
            ...
            <button style={{cursor: 'pointer', color: '#ECD1A0', backgroundColor: 'black', fontWeight: '900' }} onClick={() => setMenuItem(4)}>Components</button>
          </li>
        </ul>
      </div>
    </nav>
        ...
        <span style={{ flex: 1 }}>
          <pre>
            <code>
             &lt;Accordion&gt;<br/>
         &lt;AccordionItem&gt;<br/>
               &lt;AccordionItemHeading&gt;<br/>
                   &lt;AccordionItemButton&gt;<br/>
                      What harsh truths do you prefer to ignore?<br/>
                   &lt;/AccordionItemButton&gt;<br/>
               &lt;/AccordionItemHeading&gt;<br/>
               &lt;AccordionItemPanel&gt;<br/>
                   &lt;p&gt;<br/>
                      Exercitation in fugiat est ut ad ea cupidatat ut in<br/>
                      cupidatat occaecat ut occaecat consequat est minim minim<br/>
                      esse tempor laborum consequat esse adipisicing eu<br/>
                      reprehenderit enim.<br/>
                   &lt;/p&gt;<br/>
               &lt;/AccordionItemPanel&gt;<br/>
           &lt;/AccordionItem&gt;<br/>
           &lt;AccordionItem&gt;<br/>
               &lt;AccordionItemHeading&gt;<br/>
                   &lt;AccordionItemButton&gt;<br/>
                      Is free will real or just an illusion?<br/>
                   &lt;/AccordionItemButton&gt;<br/>
               &lt;/AccordionItemHeading&gt;<br/>
               &lt;AccordionItemPanel&gt;<br/>
                   &lt;p&gt;<br/>
                      In ad velit in ex nostrud dolore cupidatat consectetur<br/>
                      ea in ut nostrud velit in irure cillum tempor laboris<br/>
                      sed adipisicing eu esse duis nulla non.<br/>
                   &lt;/p&gt;<br/>
               &lt;/AccordionItemPanel&gt;<br/>
           &lt;/AccordionItem&gt;<br/>
         &lt;/Accordion&gt;<br/>
